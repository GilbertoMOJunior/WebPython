...
async def listar_auditoria(
    ...
    """Lista registros de auditoria com filtros opcionais. Apenas administradores (grupo 1) podem acessar."""
    try:
...
@router.get(
    "/auditoria/acoes",
    tags=["Auditoria"],
    summary="Listar tipos de ações e recursos disponíveis para filtro - protegida por JWT e grupo 1"
)
