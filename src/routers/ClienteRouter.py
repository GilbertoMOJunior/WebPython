...
@router.get(
    ...
    summary="Listar todos os clientes - protegida por autenticação"
)
...
@router.get(
    ...
    tags=["Cliente"],
    status_code=status.HTTP_200_OK,
    summary="Buscar cliente por ID - protegida por autenticação"
)
@limiter.limit(get_rate_limit("moderate"))
...
@router.post(
    ...
    tags=["Cliente"],
    summary="Criar novo cliente - protegida por JWT e grupos 1 ou 3"
)
...
@router.put(
    ...
    tags=["Cliente"],
    status_code=status.HTTP_200_OK,
    summary="Atualizar cliente - protegida por JWT e grupos 1 ou 3"
)
@limiter.limit(get_rate_limit("restrictive"))
